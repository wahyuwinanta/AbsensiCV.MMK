...
@section('content')
    <div id="header-section">
        <div class="appHeader bg-primary text-light">
            <div class="left">
                <a href="{{ route('pelanggaran.index') }}" class="headerButton goBack">
                    <ion-icon name="chevron-back-outline"></ion-icon>
                </a>
            </div>
            <div class="pageTitle">Detail Pelanggaran</div>
            <div class="right"></div>
        </div>
    </div>

    <div id="content-section" style="margin-top: 70px; padding: 15px;">
        <div class="card">
            <div class="card-body" style="padding: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 1.5; color: #000;">
                <style>
                    .letter-header {
                        text-align: center;
                        margin-bottom: 20px;
